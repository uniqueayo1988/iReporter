...
import ValidateUpdate from '../middleware/ValidateUpdate';
...
router.patch('/red-flags/:id/location', Validator.getOne, ValidateUpdate.update, Redflag.update);
router.patch('/red-flags/:id/comment', Validator.getOne, ValidateUpdate.update, Redflag.update);
